...
// PIN (BUZZER, BUTTON, & FLASH)
#define BUTTON_PIN 14
#define BUZZER_PIN 12
#define FLASH_PIN 4     // <-- Pin untuk Flash LED bawaan
...
// Variabel untuk mencegah tombol tertekan berkali-kali secara cepat (Debounce)
...
void setup() {
  ...
  pinMode(FLASH_PIN, OUTPUT);      // <-- Atur Flash sebagai Output
